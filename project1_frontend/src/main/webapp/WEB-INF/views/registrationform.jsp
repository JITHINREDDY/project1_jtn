    ...
    <div class="container">
		...
		<div class="form-group">
			...
			<form:errors path="shippingAddress.zipcode" cssStyle="color:red"></form:errors>
						...
						<div class="form-group">
							<button id="signupSubmit" type="submit" value="Register" class="btn btn-info btn-block">Create your account</button>
						</div>
						<p class="form-group">By creating an account, you agree to our <a href="#">Terms of Use</a> and our <a href="#">Privacy Policy</a>.</p>
						<hr>
						<c:url value="login" var="url1"></c:url>
						<p></p>Already have an account? <a href="${url1 }">Sign in</a></p>
					</form:form>
				</div>
			</div>
		</div>
